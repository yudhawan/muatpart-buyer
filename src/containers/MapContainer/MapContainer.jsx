...
function MapContainer({ lat = -7.2575, lng = 112.7521, zoom = 20, width, height, classname, viewOnly, textLabel, onPosition = () => {} }) {
     ...
     if (!isLoaded) return <div style={{ width: width + "px", height: height + "px" }} className={`overflow-hidden rounded-md w-[200px] h-[200px] animate-pulse bg-gray-400 ${classname}`}></div>;
     return (
