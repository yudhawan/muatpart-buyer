  ...
  return(
    <div className={`${isBgSecondary?'bg-neutral-50':'bg-[#c22716]'} relative w-full h-auto max-h-[88px] p-4 pb-3 flex gap-2 ${shadow? 'shadow-lg':''}`}>
      ...
      <div className='flex gap-2 w-full items-center'>
        ...
        {((type==='header_title' || type==='header_title_secondary')&&typeof title==='string')?<span className={`font-bold text-base ${isBgSecondary?'text-[#176cf7]':'text-neutral-50'}`}>{title}</span>:title}
        {
